      ...
      <div className="container mx-auto py-20 flex flex-col gap-6">
        {
          servicesData.map((item, i) => (
            <aside key={item.id} className={`flex flex-col gap-6 ${i % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"}`}>
              <div data-aos="fade-left" data-aos-delay="1000" className="relative min-h-44 h-44 md:h-72 rounded-md overflow-hidden shadow-lg shadow-backdrop flex-1">
                <img src={item.image} alt="" className="absolute left-o top-0 object-cover w-full h-full object-center" />
              </div>
              <div data-aos="fade-down" data-aos-delay="1000" className="flex-1 py-5 flex flex-col justify-center p-4 gap-4">
